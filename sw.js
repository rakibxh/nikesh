...
const CACHE_NAME = "nikesh-shell-v1";
  ...
  event.waitUntil(
    caches.open(CACHE_NAME).then((cache) =>
      cache.addAll(APP_SHELL).catch(() => {
        // If logo-header.png or another optional asset isn't uploaded
        // yet, don't let that block the rest of the shell from caching.
        return Promise.all(
